...
Plugin do Claude Code para scraping de catálogos JEM. **PROJETO v1 COMPLETO — Planos 1, 2, 4, 3a, 5, 6 e 7 na `main`, pushados. Plugin instalável. 194 testes passando (+1 skip: smoke Playwright).** Único item deferido: **Plano 3b — auth/token** (usuário sem login; ver §5.1). Design em rev7.
